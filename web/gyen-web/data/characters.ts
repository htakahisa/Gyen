...
export const characters: Character[] = [
    ...
    history: [
      ...
      { version: "1.0.6", change: "Yellowの上昇、下降速度を1から3に上昇" , type: "buff" as const },
      { version: "1.0.9", change: "Yellowの前進スピードを5から8に上昇" , type: "buff" as const },
      { version: "1.0.9", change: "Limeの生成前のオーブの速度が10から20に上昇" , type: "buff" as const },
    ],
    skills: [
  ...
  },
   {
    ...
    history: [
      ...
      { version: "1.0.9", change: "Horusを設置する際のプレイヤーからの最大距離が5mから8mに増加" , type: "buff" as const },
      { version: "1.0.9", change: "Horusが検知する範囲を、30mから50mに拡大" , type: "buff" as const },
    ],
    skills: [
    ...
    history: [
      ...
      { version: "1.0.9", change: "LightLoadの初期所持数が1つから3つへ増加" , type: "buff" as const },
    ],
    skills: [
    ...
    history: [
      ...
      { version: "1.0.9", change: "ITweaksの初期所持数が1つから2つに増加" , type: "buff" as const },
      { version: "1.0.9", change: "ITweaksを設置する際のプレイヤーからの最大距離が5mから6mに増加" , type: "buff" as const },
    ],
    skills: [
      { name: "Ability : IAm", description: "「生物の本質は、単体のいずれでもなく、単にその時空が所有する状態が物理的に表れたものだ。」トーテムを配置し、再起動でワープできる。" },  
      { name: "Ability : IMirror", description: "「これは簡単に言えば小さなブラックホールだ。」視界が真っ黒になる、強烈な黒い何かを飛ばす。" },
      { name: "Ability : ITweaks", description: "「この技術を使えば、特定の人間に浮動性めまいを誘発できる。」半透明なナノセンサーがスタン効果のあるビームを飛ばす。" },
    ],
           type: "Warden",
    difficulty: "やや難しい",
    from: "アメリカ合衆国",
