...
public class WeaponManager : NetworkBehaviour
{
    ...
    private Dictionary<WeaponType, WeaponData> weaponDatabase = new Dictionary<WeaponType, WeaponData>()
    {
        ...
        { WeaponType.Kafka, new WeaponData("Kafka", 30, 80, 0.07f, 0.07f, 0.07f, 20, 1.5f,true, false, 60f, 0.08f, 5, true) },
        { WeaponType.KasMi, new WeaponData("KasMi", 35, 140, 0.08f, 0.03f, 0.06f, 30, 1.7f,true, false, 50f, 0.06f, 2, true) },
        { WeaponType.Hirtuarl, new WeaponData("Hirtuarl", 40, 160, 0.1f, 0.06f, 0.08f, 25, 1.5f,true, false, 55f, 0.1f, 1, true) },
        { WeaponType.Hazard, new WeaponData("Hazard", 150, 200, 1f, 0f, 0f, 5, 3f,true, true, 30f, 0.2f, 1, false) },
        { WeaponType.RapetPuppet, new WeaponData("RapetPuppet", 50, 100, 0.06f, 0.12f, 0.03f, 100, 4f,true, true, 45f, 0.5f, 1, true) },
    };
